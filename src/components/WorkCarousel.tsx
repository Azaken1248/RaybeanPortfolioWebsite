    ...
    <div className="relative">
      ...
      <div className="mt-2 flex items-center justify-end gap-2">
        <button
          ...
          className="grid size-10 cursor-pointer place-items-center rounded-full bg-periwinkle/40 text-ink transition hover:bg-ink hover:text-bg disabled:cursor-default disabled:opacity-35 disabled:hover:bg-periwinkle/40 disabled:hover:text-ink"
        >
