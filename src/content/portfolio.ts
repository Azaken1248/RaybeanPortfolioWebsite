...
export const defaultPortfolio: PortfolioData = {
  ...
  /*
   * TODO(ray): placeholder works. The images are generated palette tiles and the
   * titles are slot descriptions — replace both with the real thing.
   *
  ...
  works: [
    {
      ...
      group: "featured-gfx",
      medium: "image",
      image: "/works/placeholder-01.webp",
      alt: "Placeholder for a featured graphic design work",
      featured: true,
      sortOrder: 1,
    },
    {
      id: "work-02",
      title: "osu! storyboard",
      discipline: "video",
      group: "storyboards",
      medium: "storyboard",
      image: "/works/placeholder-02.webp",
      alt: "Placeholder for an osu! storyboard",
      featured: true,
      sortOrder: 2,
    },
    {
      ...
      group: "best-works",
      medium: "image",
      image: "/works/placeholder-03.webp",
      alt: "Placeholder for an illustration",
      featured: true,
      sortOrder: 3,
    },
    {
      ...
      group: "best-works",
      medium: "image",
      image: "/works/placeholder-04.webp",
      alt: "Placeholder for a character illustration",
      featured: true,
      sortOrder: 4,
    },
    {
      id: "work-05",
      title: "osu! World Cup graphics",
      discipline: "graphic-design",
      group: "osu-projects",
      medium: "image",
      image: "/works/placeholder-05.webp",
      alt: "Placeholder for an osu! World Cup graphic",
      featured: true,
      sortOrder: 5,
    },
    {
      ...
      group: "best-works",
      medium: "image",
      image: "/works/placeholder-06.webp",
      alt: "Placeholder for a cover illustration",
      featured: true,
      sortOrder: 6,
    },
  ],
